...
[L_COLEMAK] = LAYOUT_wrapper(
  ...
  TD_LAYR, KC_LGUI, KC_TAB,  KC_LSFT, KX_BKNM, KX_DCTL, KX_NALT, KX_SPAC, TT_SYMB, KC_MINS, KC_QUOT, KC_EQL
)
,
...
[L_NUM] = LAYOUT_wrapper(
  ...
  _______, _______, _______, _______, ooooooo, _______, KC_ENT,  _______, KC_0,    KC_DOT,  KC_EQL,  KC_PLUS
)
,
