...
[L_COLEMAK] = LAYOUT_ergodox_pretty_wrapper(
  ...
  KX_ECTL ,__________________COLEMAK_L1_EX____________ ,KC_LBRC ,         KC_DEL  ,__________________COLEMAK_R1_EX____________ ,KC_BSLS,
  KC_TAB  ,__________________COLEMAK_L2_EX____________ ,                           __________________COLEMAK_R2_EX____________ ,KC_QUOT,
  KC_LSFT ,__________________COLEMAK_L3_EX____________ ,KC_RBRC ,         KC_LOCK ,__________________COLEMAK_R3_EX____________ ,KC_RSFT,
...
[L_QWERTY] = LAYOUT_ergodox_pretty_wrapper(
  ...
  _______ ,_________________L_QWERTY_L2_______________ ,                           _________________L_QWERTY_R2_______________ ,_______ ,
  _______ ,_________________L_QWERTY_L3_______________ ,_______ ,         KC_LOCK ,_________________L_QWERTY_R3_______________ ,_______ ,
...
[L_GAMING] = LAYOUT_ergodox_pretty_wrapper(
  _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,_______ ,         _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,_______ ,
  KC_ESC  ,__________________COLEMAK_L1_______________ ,_______ ,         _______ ,__________________COLEMAK_R1_______________ ,_______ ,
  _______ ,__________________COLEMAK_L2_______________ ,                           __________________COLEMAK_R2_______________ ,_______ ,
  KC_LSFT, __________________COLEMAK_L3_______________ ,_______ ,         _______ ,_______ ,_______ ,_______ ,_______ ,KC_UP,   KC_SLSH,
